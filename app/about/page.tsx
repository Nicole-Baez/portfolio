...
export default function AboutPage() {
  return (
    ...
    <div className="flex flex-col text-center justify-items-center items-center sm:items-start sm:text-left pt-20">
      <h1 className="font-bold text-black font-mono gap-4 items-center">
        About Me:
      </h1>

      <p className="text-black font-mono text-smmax-w-md pt-2 items-center">
